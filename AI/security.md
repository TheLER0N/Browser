...
| **PrintScreen** | Глобальный хук клавиатуры (GlobalHotkey.cs) | ✅ Реализовано |
| **Snipping Tool** | Обработка WM_PRINTCLIENT (SnippingToolBlocker.cs) | ✅ Реализовано |
| **Скриншоты WebView2** | Отключение CapturePreview API (ScreenshotBlocker.cs) | ✅ Реализовано |
...
| **Отслеживание через fingerprint** | Кастомный User-Agent, блокировка Canvas | ✅ Реализовано |
